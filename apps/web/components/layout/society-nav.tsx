...
export function SocietyNav({
  ...
  return (
    <header className="border-b border-palette-navy/10 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/85 sticky top-0 z-50">
      <div className="container mx-auto px-4">
        <div className="flex h-16 items-center justify-between">
          <div className="flex items-center gap-4">
            <Link
              href={`/${societySlug}/dashboard`}
              className="font-bold text-lg text-palette-navy tracking-tight"
            >
              {societyName}
            </Link>
          </div>
